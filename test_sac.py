...
USE_CUDA = False
save_dir = '/home/dong/PycharmProjects/RLeMPC/runs/sacd-20220618-1037-0.01/model/model195'
...
def run(args):
    ...
    agent.policy.load_state_dict(torch.load(os.path.join(save_dir, 'policy.pth')))
    agent.policy.eval()
    agent.test()
